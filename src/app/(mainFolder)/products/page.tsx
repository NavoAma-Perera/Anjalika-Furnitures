...
const initialProducts: Product[] = [
  {
    ...
    price: 25000,
    description: "Premium solid wood sofa with soft cushions — handcrafted for style and comfort.",
    stock: 5,
  ...
  },
  {
    ...
    price: 12000,
    description: "Stylish and functional TV stand, perfect for modern living rooms.",
    stock: 3,
  ...
  },
  {
    ...
    category: "Wooden Furniture",
    price: 32000,
    description: "Elegant 6-seater dining table made from high-quality mahogany wood.",
    stock: 4,
    images: ["/6seats.jpg"],
  },
  {
    ...
    price: 28000,
    description: "Spacious wardrobe with modern sliding doors and mirror finish.",
    stock: 2,
  ...
  },
  {
    ...
    category: "Customized Furniture",
    price: 15000,
    description: "Compact and ergonomic study table ideal for students or home offices.",
    stock: 8,
  ...
  },
  {
    ...
    category: "Wooden Furniture",
    price: 35000,
    description: "Strong and elegant bed frame with a polished teakwood finish.",
    stock: 6,
...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <h1 className="text-3xl font-bold mb-1 text-gray-800">Products Management</h1>
      <p className="text-gray-600 mb-6">
        Manage all furniture products efficiently — add, edit, or remove product details and images.
      </p>
      ...
      {mode !== "add" && mode !== "edit" && (
        <>
          <button
            ...
            className="mb-5 px-5 py-2 bg-amber-800 text-white rounded-md hover:bg-amber-900 transition"
          >
            + Add Product
          </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map(p => (
              <div key={p.id} className="bg-white p-5 rounded-lg shadow hover:shadow-lg transition">
                <h2 className="text-xl font-semibold text-gray-800">{p.name}</h2>
                <p className="text-gray-500 mt-1">{p.category}</p>
                <p className="mt-2 text-gray-600">{p.description}</p>
                <p className="mt-2 font-bold text-gray-900">Rs. {p.price.toLocaleString()}</p>
                ...
                <div className="mt-4 flex gap-3">
                  <button
                    onClick={() => router.push(`/products?mode=edit&id=${p.id}`)}
                    className="px-3 py-1 bg-amber-800 text-white rounded hover:bg-amber-900 transition"
                  >
                    Edit
                  </button>
                  <button
      ...
      {(mode === "add" || mode === "edit") && (
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="mb-4">
              <label className="block font-medium mb-1 text-gray-700">Price (Rs.)</label>
              <input
                type="number"
                name="price"
                value={product.price}
          ...
          <div className="mb-4">
            <label className="block font-medium mb-2 text-gray-700">Images (up to 3)</label>
