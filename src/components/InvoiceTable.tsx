              ...
              <tr key={invoice.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-sm">
                  <div className="flex gap-2">
                    <button onClick={() => onViewDetails(invoice)} className="text-orange-600 hover:text-orange-800">
                    ...
                    {invoice.balance > 0 && (
                      <button onClick={() => onRecordPayment(invoice)} className="text-green-600 hover:text-green-800 text-xs font-medium">
                        Record Payment
                      </button>
                    )}
                  </div>
